...
合计: **38,668** 行代码（覆盖前 5 种语言、共 **188** 个文件）。
...
- **上游仓库**: <https://github.com/dlvhdr/gh-dash>
- **官网**: <https://gh-dash.dev>
- **许可证**: MIT
...
- **Star**: 12,505 · **Fork**: 438 · **开放 issue**: 317 · **贡献者**: 100

## 累计统计

- **发布数**: 88 · **已合并 PR**: 481 · **开放 PR**: 15 · **已关闭 issue**: 231 · **开放 issue**: 86 · **提交数**: 646

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-12 | 0 | 1 | 3 | 0 | 4 | 2 |
| last60d | 2026-07-13 | 0 | 2 | 4 | 2 | 12 | 4 |
| 90d | 2026-06-13 | 3 | 10 | 5 | 7 | 17 | 16 |
| last180d | 2026-03-15 | 5 | 60 | 10 | 23 | 29 | 71 |
| 360d | 2025-09-16 | 16 | 181 | 15 | 55 | 42 | 179 |
| last720d | 2024-09-21 | 34 | 278 | 15 | 87 | 62 | 314 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/gh-dash.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T19:39:45Z._
